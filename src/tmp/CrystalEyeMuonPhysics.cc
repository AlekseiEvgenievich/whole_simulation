...
#include "CrystalEyeMuonPhysics.hh"
...
CrystalEyeMuonPhysics::CrystalEyeMuonPhysics(const G4String& name)
                   :  G4VPhysicsConstructor(name)
{
}

CrystalEyeMuonPhysics::~CrystalEyeMuonPhysics()
{
}

void CrystalEyeMuonPhysics::ConstructParticle()
{
...
void CrystalEyeMuonPhysics::ConstructProcess()
{
