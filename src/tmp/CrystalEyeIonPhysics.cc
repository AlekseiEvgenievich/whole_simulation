...
#include "CrystalEyeIonPhysics.hh"
...
CrystalEyeIonPhysics::CrystalEyeIonPhysics(const G4String& name)
                 :  G4VPhysicsConstructor(name)
{;}

CrystalEyeIonPhysics::~CrystalEyeIonPhysics()
{;}

void CrystalEyeIonPhysics::ConstructParticle()
{;}
...
void CrystalEyeIonPhysics::ConstructProcess()
{
