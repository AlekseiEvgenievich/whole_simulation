...
#include "CrystalEyeEMlowePhysics.hh"
...
CrystalEyeEMlowePhysics::CrystalEyeEMlowePhysics(const G4String& name)
               :  G4VPhysicsConstructor(name)
{
}

CrystalEyeEMlowePhysics::~CrystalEyeEMlowePhysics()
{
}

void CrystalEyeEMlowePhysics::ConstructParticle()
{
}
...
void CrystalEyeEMlowePhysics::ConstructProcess()
{
