...
#include "CrystalEyeHadronPhysics.hh"
#include "globals.hh"
#include "G4ios.hh"
...
CrystalEyeHadronPhysics::CrystalEyeHadronPhysics(const G4String& name)
                    :  G4VPhysicsConstructor(name)
{;}

CrystalEyeHadronPhysics::~CrystalEyeHadronPhysics()
{
...
void CrystalEyeHadronPhysics::ConstructProcess()
{

  G4ProcessManager * pManager = 0;
  /*
  G4cout << "" << G4endl;
  G4cout << "You are using the CrystalEyeHadronPhysics" << G4endl;
