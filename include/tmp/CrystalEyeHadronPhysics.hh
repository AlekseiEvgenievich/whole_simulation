...
//
// ------------------------------------------------------------
#ifndef CrystalEyeHadronPhysics_h
#define CrystalEyeHadronPhysics_h 1
...
class CrystalEyeHadronPhysics : public G4VPhysicsConstructor
{
  public: 
    CrystalEyeHadronPhysics(const G4String& name ="hadron");
    virtual ~CrystalEyeHadronPhysics();
