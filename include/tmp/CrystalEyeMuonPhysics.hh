...
// ------------------------------------------------------------
#ifndef CrystalEyeMuonPhysics_h
#define CrystalEyeMuonPhysics_h 1
...
class CrystalEyeMuonPhysics : public G4VPhysicsConstructor
{
  public: 
    CrystalEyeMuonPhysics(const G4String& name="muon");
    virtual ~CrystalEyeMuonPhysics();
