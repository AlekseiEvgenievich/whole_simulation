...
// ------------------------------------------------------------
#ifndef CrystalEyeIonPhysics_h
#define CrystalEyeIonPhysics_h 1
...
class CrystalEyeIonPhysics : public G4VPhysicsConstructor
{
  public: 
    CrystalEyeIonPhysics(const G4String& name="ion");
    virtual ~CrystalEyeIonPhysics();
